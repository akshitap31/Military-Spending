...
function updatePlotly() {
  ...
  d3.json(url).then(function (data) {
    ...
    var button = document.getElementById("selDataset");
  ...
  d3.json(url3).then(function (data) {
    ...
    var chart3 = new Chart(
      document.getElementById("doughnut-chart3").getContext("2d"),
      {
        type: "doughnut",
        data: {
          labels: Object.entries(data_dict),
...
function init() {
  ...
  d3.json(url4).then(function (data) {
    ...
    var chart2 = new Chart(
      document.getElementById("doughnut-chart4").getContext("2d"),
      {
        type: "doughnut",
        data: {
          labels: Object.entries(data_dict),
  ...
  d3.json(url2).then(function (data) {
    ...
    var chart4 = new Chart(
      document.getElementById("doughnut-chart2").getContext("2d"),
      {
        type: "doughnut",
        data: {
          labels: Object.entries(data_dict),
